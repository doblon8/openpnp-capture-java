...
public final class CapCustomLogFunc {
    ...
    public interface Function {
        void apply(int level, MemorySegment string);
    }
    ...
    private static final MethodHandle UP$MH = openpnp_capture.upcallHandle(CapCustomLogFunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(CapCustomLogFunc.Function fi, Arena arena) {
